...
export const interstitials = {
  ...
  4: {
    type: "testimonial",
    icon: "💬",
    headline: "Uma paciente real do Dr. Alberto (avaliação verificada no Doctoralia):",
    quote:
      "Fiz meu pré-natal todo com o Dr. Alberto e todas as suas sugestões e cuidados me possibilitaram ter um parto do jeitinho que eu queria. Obrigada por tudo, Dr. e equipe!",
    author: "Márcia",
    meta: "★★★★★ · consulta verificada · Doctoralia",
    cta: "Quero um parto do jeito que eu quero →",
  },
  6: {
    type: "authority",
    icon: "🩺",
...
export const depoimentos = [
  {
    texto:
      "Passei com o Dr. para acompanhamento e logo depois engravidei. Fiz todo o meu pré-natal e o parto também com ele. Me senti super segura e consciente de tudo. Agora que minha bebê nasceu, sigo com ele.",
    autor: "Paciente verificada",
    fonte: "Doctoralia · consulta verificada",
  },
  {
    texto:
      "Extremamente atencioso, empático, atualizado e humanizado. Sempre disposto a esclarecer todas as dúvidas e, principalmente, me deixar segura no decorrer de toda a gestação. Um médico que respeita e apoia seu protagonismo como mãe e mulher.",
    autor: "Francine Araujo",
    fonte: "Doctoralia · consulta verificada",
  },
  {
    texto:
      "Amo o profissional que o Dr é! Acompanhou minha gestação e agora o pós-parto. Ele é super atencioso, além de ser uma referência na área dele.",
    autor: "Karina",
    fonte: "Doctoralia · consulta verificada",
  },
];
