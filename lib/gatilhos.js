...
function trilhaConversando(lead, sdr) {
  ...
  return [
    {
      id: "mapa",
      quando: "Quando ela responde NÃO à pergunta de sim/não",
      mecanismo: "Entregar na hora o que ela acabou de admitir que nunca teve",
      porque:
        "Ela confessou uma lacuna. Se você vender agora, vira oportunismo. Se você preencher a lacuna de graça, na hora, você PROVA o que o método faz em vez de prometer — e ela passa a te dever uma.",
      texto: `Pois é, ${n} — e olha, quase ninguém responde sim nessa pergunta. Não é falha sua, é falha de quem devia ter te explicado.

Então deixa eu te dar isso agora, de graça. O trabalho de parto tem três fases:

1️⃣ **Dilatação** — a mais longa de todas. É o corpo abrindo caminho, e as contrações vão ficando mais próximas umas das outras. É aqui que a maioria das mulheres se desespera achando que já era pra estar acabando.

2️⃣ **Expulsivo** — quando vem a vontade de empurrar. Costuma ser bem mais curta que a primeira, e o corpo passa a te avisar o que fazer.

3️⃣ **Dequitação** — a saída da placenta, depois que o bebê já nasceu. Praticamente ninguém comenta essa, e é justamente por isso que ela assusta.

Isso é só o esqueleto — quem acompanha o seu caso é o seu obstetra. Mas repara: nenhuma das três é aquela cena de filme.

Qual dessas três você nunca tinha ouvido falar?`,
    },
    {
      id: "aprofundar",
      quando: "Depois que ela reagir ao mapa das 3 fases",
